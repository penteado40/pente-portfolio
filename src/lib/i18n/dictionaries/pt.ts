...
export const pt: Record<TranslationKey, string> = {
  ...
  "common.sourceCode": "Codigo",
  "common.liveDemo": "Demonstracao",
  "common.listen": "Ouvir",
  "common.languageToggle": "Mudar para ingles",
  ...
  "dev.hero.subtitle":
    "Projeto e desenvolvo APIs, servicos e ferramentas internas, com foco em corretude, observabilidade e manutenibilidade.",
  "dev.hero.cta": "Ver projetos",
  "dev.about.title": "Sobre",
  "dev.skills.title": "Habilidades e ferramentas",
  "dev.projects.title": "Projetos",
  "dev.cta.title": "Tem um sistema para construir ou corrigir?",
  "dev.cta.subtitle":
  ...
  "notFound.cta": "Voltar para o inicio",
};
